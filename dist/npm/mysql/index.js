...
function loadClass(className) {
  ...
  switch (className) {
    case 'Connection':
      Class = require('./lib/Connection.js');
      break;
    case 'ConnectionConfig':
      Class = require('./lib/ConnectionConfig.js');
      break;
    case 'Pool':
      Class = require('./lib/Pool.js');
      break;
    case 'PoolCluster':
      Class = require('./lib/PoolCluster.js');
      break;
    case 'PoolConfig':
      Class = require('./lib/PoolConfig.js');
      break;
    case 'SqlString':
      Class = require('./lib/protocol/SqlString.js');
      break;
    case 'Types':
      Class = require('./lib/protocol/constants/types.js');
      break;
    default:
